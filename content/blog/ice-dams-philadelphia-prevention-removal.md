...
faq:
  ...
  - question: "Are ice dams covered by homeowners insurance?"
    answer: "Sudden interior water damage from an ice dam (ruined drywall, soaked carpet, damaged contents) is typically covered under most Pennsylvania homeowners policies as a covered peril. The roof damage itself and the cost of removing the ice are sometimes covered and sometimes excluded, depending on policy language — read your declarations page. The longer-term causes (insufficient insulation, missing ventilation, gaps in attic air sealing) are considered maintenance issues and are not covered. Document everything with photos before any cleanup, file the claim promptly, and we can provide the insurance-ready damage documentation your adjuster needs."
