...
export const services: Service[] = [
  ...
  },
  {
    ...
    tagline: "Expert Asphalt Shingle Roofing in Philadelphia PA",
    category: "shingles",
    description:
      "Professional asphalt shingle roofing installation and replacement in Philadelphia. 3-tab and architectural asphalt shingles from top brands for lasting protection and curb appeal.",
    icon: "",
    image: "/images/roof-shingles-philadelphia.jpg",
    heroDescription:
      "Asphalt shingles are by far the most popular roofing material in Philadelphia and across the United States, and for good reason — they deliver an excellent combination of weather protection, aesthetic appeal, and value that is hard to beat. At Adilay Roofing, licensed under PA184779, we are asphalt shingle roofing specialists serving homeowners throughout Philadelphia and the surrounding areas of Bucks County, Montgomery County, Delaware County, and Chester County. We install a full range of asphalt shingle products including traditional 3-tab shingles for budget-conscious homeowners and premium dimensional architectural shingles for those who want superior durability, wind resistance, and a high-end multi-dimensional appearance. Asphalt shingles are specifically engineered to handle the demands of the Mid-Atlantic climate — from the intense summer heat and UV exposure to heavy rain, high winds, and winter ice and snow that Philadelphia experiences throughout the year. We work with top-tier asphalt shingle manufacturers including GAF, CertainTeed, and Owens Corning, giving you access to industry-leading warranty coverage and products that have been tested and proven in real-world conditions. Our asphalt shingle roofing services include new roof installation, complete tear-off and replacement, and upgrades from 3-tab to architectural shingles. Every project includes proper underlayment, ice and water shield in vulnerable areas, ridge ventilation, and clean, professional flashing work. Contact Adilay Roofing today for a free asphalt shingle roofing estimate in Philadelphia.",
    benefits: [
