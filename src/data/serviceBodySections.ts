...
export const SERVICE_BODY_SECTIONS: Record<string, BodySection[]> = {
  ...
  "roof-repair": [
    {
      heading: "Common Roof Problems by Philadelphia Housing Era",
      html: "<p>Philadelphia's housing stock spans 200+ years and the roof problems we diagnose split cleanly along construction era. <strong>Pre-1930 rowhomes and Victorians</strong> (Fishtown, Kensington, Old City, parts of West Philly): original slate or first-generation flat-roof tar systems, with copper flashing past end-of-life and skip-sheathed wood decking that's compressed under decades of moisture. <strong>1930s–1950s twins and singles</strong> (Northeast, Southwest Philly, Mt. Airy): original cedar shake replaced once with 3-tab asphalt, now on third-generation architectural shingles, with chronic ventilation problems no one ever addressed. <strong>Post-WWII to 1980s suburbs</strong> (most of Northeast, parts of Roxborough, Bucks/Montco/Delco subdivisions): three layers of asphalt shingles with no ventilation upgrades, ice damming every February at the eaves. <strong>1990s–2010s newer construction</strong>: builder-grade architectural shingles installed without ice-and-water shield in valleys, ridge vent installed on top of plywood without proper slot cuts. We diagnose by era because the failure modes are predictable.</p>",
    },
    {
      heading: "What's a Repair vs What's a Replacement Conversation",
      html: "<p>Honest line we draw: a repair makes sense when <strong>the rest of the roof has 5+ years of life left</strong> and the damage is localized — a single chimney flashing, a broken vent boot, one section of flashing at a sidewall, a tree branch puncture. A repair on a 22-year-old roof with widespread granule loss, curling, and multiple leaks isn't a repair, it's a delay tactic — and delay is how a $1,200 problem turns into a $20,000 ceiling-and-drywall claim. Our diagnostic walk takes 25 minutes: roof access, attic inspection with a moisture meter, photographs of every failure point, and a written assessment that says either \"here's the repair scope, $X\" or \"this roof is at end-of-life, replacement is the right call.\" No upselling, no pressure. We've recommended repairs on jobs where competitors quoted full replacements, and we've recommended replacements on jobs where homeowners were hoping for cheap repairs. Honest is the only way we know how to operate.</p>",
    },
    {
      heading: "Repair Pricing in Philadelphia — Real Ranges, Not Guesses",
      html: "<p>Most Philadelphia roof repairs we do fall into these brackets, written in 2026 dollars:</p><ul><li><strong>Single broken slate or shingle replacement</strong> — $250–$500. Same-day or next-day for active leaks.</li><li><strong>Vent boot replacement</strong> (the rubber gasket around plumbing stacks that fails after 8–12 years from UV) — $300–$650 per stack, including new boot, new flashing, and the surrounding shingles.</li><li><strong>Chimney flashing rework</strong> — $850–$2,200 depending on chimney size, whether step flashing needs full replacement, and whether counter-flashing must be cut into existing mortar joints.</li><li><strong>Skylight reseal or replacement</strong> — $450 reseal, $1,400–$3,500 full replacement (Velux units, plus curb adjustment if existing curb is wrong size).</li><li><strong>Section flashing at sidewall</strong> — $700–$1,800 for step-flashing rework along a 6–12 ft wall.</li><li><strong>Localized flat-roof patch</strong> — $400–$1,200 for an EPDM patch heat-welded or seamed to existing membrane.</li></ul><p>Anything outside these ranges, we explain why before you sign.</p>",
    },
    {
      heading: "Why Most \"Roof Repair\" Calls Are Actually Flashing Calls",
      html: "<p>A leaking roof rarely means leaking shingles. Roughly 80% of the leak repairs we do in Philadelphia trace back to <strong>flashing failures</strong>, not field shingle failures. The five most common culprits, in order: <strong>chimney flashing</strong> (water travels down the back of the chimney where snow accumulates, finds a pinhole in old copper, drops onto the deck), <strong>vent boot rubber</strong> (UV cracks the gasket around plumbing stacks after 8–12 years), <strong>step flashing at sidewalls</strong> (where a roof meets a vertical wall; original flashing was buried under siding and never reflashed when the siding was last redone), <strong>valley flashing</strong> (old W-valleys that should have been replaced when the roof was reshingled), and <strong>skylight curbs</strong> (the metal curb-to-deck seal fails before the lens does). Knowing the actual failure point matters because slathering roof cement over the visible leak — what unscrupulous contractors do — masks the real problem for 12–18 months and lets damage continue underneath.</p>",
    },
    {
      heading: "When Insurance Should Pay vs When It's an Out-of-Pocket Repair",
      html: "<p>Quick rule that saves time: insurance covers <strong>sudden, accidental damage</strong> (storm wind, hail, fallen tree, ice dam-induced interior damage). Insurance does <em>not</em> cover <strong>wear-out failures</strong> (an old roof at end-of-life, granule loss from age, flashing that finally gave up after 30 years). If your roof is leaking after a specific storm event, file the claim — most major Pennsylvania carriers (State Farm, Allstate, USAA, Liberty Mutual, Travelers, Erie) cover storm-related repairs subject to your deductible. If your roof is leaking on a calm sunny day in October because it's just old, that's an out-of-pocket repair or replacement. We document either way: written scope, date-stamped photos, and an honest opinion on whether the claim is defensible. Filing claims that get denied hurts your insurance record; we'd rather you not file than file a losing claim.</p>",
    },
  ],
