...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* ============================================ */}
      {/* FEATURE ROW — 6 tiles under the hero          */}
      {/* ============================================ */}
      <section className="bg-white border-b border-brand-border">
        <div className="container-wide mx-auto px-4 py-5 md:py-8">
          <ul className="grid grid-cols-3 md:grid-cols-6 gap-1 md:gap-4">
            {[
              { label: "On-Time", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
              { label: "Trusted Crew", icon: "M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6 5.87v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2M16 7a4 4 0 11-8 0 4 4 0 018 0z" },
              ...
              { label: "GAF Certified", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" },
            ].map((f) => (
              <li
                key={f.label}
                className="flex flex-col items-center text-center p-2 md:p-3"
              >
                <div className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-brand-red/10 text-brand-red flex items-center justify-center mb-1 md:mb-2">
                  <svg
                ...
                <p className="text-[11px] md:text-sm font-bold text-brand-dark leading-tight">
                  {f.label}
                </p>
              </li>
            ))}
