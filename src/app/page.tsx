      ...
      <section className="bg-brand-darker">
        <div className="container-wide mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {[
              { src: "/images/crew-flat-roof-action.png", alt: "Adilay Roofing crew installing EPDM membrane on a Philadelphia flat roof", pos: "object-top md:object-[50%_30%] md:scale-105 md:origin-[50%_30%]" },
