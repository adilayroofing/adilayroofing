...
export const metadata: Metadata = {
  ...
  description:
    "Request your free, no-obligation roofing estimate from Adilay Roofing. Free gutter cleaning with every roof replacement. Serving Philadelphia & surrounding counties. Call (888) 823-4766.",
